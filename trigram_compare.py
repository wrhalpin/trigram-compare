...
–coverage          Show coverage map segments
...
from trigram_index import TrigramIndex, SimilarityReport, Hotspot, CoverageSegment
...
return red(verdict)
if “HIGHLY” in verdict or “EMBEDDED” in verdict:
return red(verdict)
if “SHARED CODE” in verdict:
...
def render_report(report: SimilarityReport, show_hotspots: int = 10,
show_coverage: bool = True) -> None:
w = 70
line = “─” * w
...
return {
“files”: {
“a”: {“path”: report.path_a, “size”: report.size_a,
“total_trigrams”: report.total_trigrams_a,
“unique_trigrams”: report.unique_trigrams_a},
“b”: {“path”: report.path_b, “size”: report.size_b,
...
“hotspots”: [
{“offset_a”: h.offset_a, “offset_b”: h.offset_b,
“length”: h.length, “trigram_count”: h.trigram_count,
...
parser.add_argument(”–window”, type=int, default=256, metavar=“SIZE”,
help=“Analysis window size in bytes (default: 256)”)
parser.add_argument(”–threshold”, type=float, default=0.25, metavar=“FLOAT”,
